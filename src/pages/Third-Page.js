        ...
        <div className="w-full">
            <div className="max-w-screen-2xl mx-auto py-5 px-5">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-5">
                    <div className="bg-white border-4 border-black sm:border-white border-b-0 border-r-0 border-l-0 xl:py-20 py-32 px-4 flex flex-col items-center justify-center shadow-lg min-h-[50px] md:col-span-2 lg:col-span-1">
                    ...
                    <div className="border-4 border-r-0 border-l-0 border-white sm:border-black bg-white py-32 px-10 flex flex-col items-center justify-center min-h-[50px] shadow-lg ">
                        <div className="flex flex-col">
                    ...
                    <div className="border-r-4 border-white sm:border-black bg-white py-32 px-10 flex flex-col items-center justify-center  shadow-lg min-h-[50px]">
                        <div className="flex flex-col">
                            <div className="flex items-center justify-center pb-6">
